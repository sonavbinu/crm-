...
const EmployeeProfile = () => {
  ...
  return (
    <Card className="flex items-center justify-center max-w-7xl">
      <div className="border border-gray-100 shadow-xl p-10 rounded-xl w-full bg-white dark:bg-slate-900 ">
        <div className="flex gap-4 items-center dark:bg-gray-500 bg-blue-50 border-blue-200 border p-3 rounded-3xl">
